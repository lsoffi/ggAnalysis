...
// Wed Jul 26 11:27:28 2017 by ROOT version 6.06/01
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: /eos/cms/store/group/phys_egamma/soffi/CMSPOS2017/ggntuples/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root
//////////////////////////////////////////////////////////

#ifndef AnalysisMASTER_h
#define AnalysisMASTER_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   std::vector<float>   *phoCITKChIso;
   std::vector<float>   *phoCITKPhoIso;
   std::vector<float>   *phoCITKNeuIso;
   ...
   std::vector<float>   *phoScale_stat_up;
   std::vector<float>   *phoScale_stat_dn;
   std::vector<float>   *phoScale_syst_up;
   std::vector<float>   *phoScale_syst_dn;
   std::vector<float>   *phoScale_gain_up;
   std::vector<float>   *phoScale_gain_dn;
   std::vector<float>   *phoResol_rho_up;
   std::vector<float>   *phoResol_rho_dn;
   std::vector<float>   *phoResol_phi_up;
   std::vector<float>   *phoResol_phi_dn;
   Int_t           npfPho;
   ...
   std::vector<float>   *eleScale_stat_up;
   std::vector<float>   *eleScale_stat_dn;
   std::vector<float>   *eleScale_syst_up;
   std::vector<float>   *eleScale_syst_dn;
   std::vector<float>   *eleScale_gain_up;
   std::vector<float>   *eleScale_gain_dn;
   std::vector<float>   *eleResol_rho_up;
   std::vector<float>   *eleResol_rho_dn;
   std::vector<float>   *eleResol_phi_up;
   std::vector<float>   *eleResol_phi_dn;
   Int_t           npfHF;
   ...
   AnalysisMASTER(TTree *tree=0);
   virtual ~AnalysisMASTER();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int whichSample, int maxEvents, double weight);
...
#ifdef AnalysisMASTER_cxx
AnalysisMASTER::AnalysisMASTER(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_egamma/soffi/CMSPOS2017/ggntuples/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_egamma/soffi/CMSPOS2017/ggntuples/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_egamma/soffi/CMSPOS2017/ggntuples/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root:/ggNtuplizer");
...
AnalysisMASTER::~AnalysisMASTER()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AnalysisMASTER::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalysisMASTER::LoadTree(Long64_t entry)
{
...
void AnalysisMASTER::Init(TTree *tree)
{
...
void AnalysisMASTER::Show(Long64_t entry)
{
...
Int_t AnalysisMASTER::Cut(Long64_t entry)
{
...
#endif // #ifdef AnalysisMASTER_cxx
