...
#include "AnalysisMASTER.C"

using namespace std;



int runAnalysisMASTER(int whichSample=1, int maxEvents=1000) {
  ...
  if(whichSample==2)weight=0.0102; //VH
  if(whichSample==3)weight=0.00029; //VBF
  if(whichSample==4)weight=0.00014; //ttH
